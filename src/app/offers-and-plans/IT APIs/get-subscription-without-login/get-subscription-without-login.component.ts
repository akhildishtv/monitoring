...
@Component({
  selector: 'app-get-subscription-without-login',
  templateUrl: './get-subscription-without-login.component.html',
  styleUrls: ['./get-subscription-without-login.component.scss']
})
export class GetSubscriptionWithoutLoginComponent implements OnInit {
  ...
  getData(tag) {
    ...
    this.APIService.GetActiveSubscriptions()
      .subscribe(data => {
