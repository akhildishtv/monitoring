...
@Component({
  selector: 'app-get-subscription-histroy',
  templateUrl: './get-subscription-histroy.component.html',
  styleUrls: ['./get-subscription-histroy.component.scss']
})
export class GetSubscriptionHistroyComponent implements OnInit {
  ...
  getData(tag) {
    ...
    this.APIService.getOTTPlansSubscriptionHistory(value)
      .subscribe(data => {
